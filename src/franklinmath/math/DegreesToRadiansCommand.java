 ...
 * @author Allen Jordan
 */
public class DegreesToRadiansCommand extends Command {
    ...
    public FMResult Execute(Vector<Equation> args, ExpressionToolset expressionToolset) throws CommandException {
        ...
        try {
            ...
            term = term.AppendPower(new Power(new Factor(new SymbolicFunction("Pi", new Vector<Equation>(), true))), PowerOperator.MULTIPLY);
            term = term.AppendPower(new Power(new Factor(180)), PowerOperator.DIVIDE);
